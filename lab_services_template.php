...
<?php get_header(); 
/*
Template Name: lab services page
*/
?>
...
<section class="strat-bgg">
  <div class="container">
    <div class="col-md-12 startup">
      <h3> TOXICOLOGY LAB<br>MANAGEMENT</h3>
    </div>
  </div>
</section>
...
<?php
    $args = array(
    'posts_per_page'    => -1,
    'post_type'     => 'Confocal_Lab',  //choose post type here
    'order' => 'ASC',
);
// query
...
<?php   $id = get_the_ID();
   ...
   if ( count( $vehilceDetails ) > 0 && is_array($vehilceDetails)) {
	        foreach( $vehilceDetails as $vehilceDetail ) {?>
              <div class="col">
            	<img src="<?=$vehilceDetails[$c]['image'];?>" alt="">
            </div>
    <?php   $c = $c +1;  }
   }
    ?>
